...
> **输出物**：8D 报告 .xlsx（6 Sheet）+ 8D 报告 .docx（标准文档）
...
2. **保证报告规范性**——所有 6 个 Sheet / 8 个章节均按 IATF 16949 与 VDA 框架预填模板，避免漏项
...
- 生成 `8D报告_{product}_{defect}_模板.xlsx`（6 Sheet）
...
- xlsx 文件路径 + 一句话说明（"6 Sheet 完整 Excel，可继续编辑"）
- docx 文件路径 + 一句话说明（"标准 Word 文档，可直接提交客户"）
- 已匹配的模板 slug 和预填的 5Why 路径摘要
...
|---|---|---|---|
| D0 | 准备 | 立项、初步评估严重度 | Sheet 1 / Word 第一章 |
| D1 | 团队组建 | 跨职能小组成立 | Sheet 1 / Word 第一章 |
| D2 | 问题描述 | 5W2H 描述问题 | Sheet 1 / Word 第一章 |
| D3 | 临时遏制措施 | 隔离不良品、保护客户 | Sheet 2 / Word 第二章 |
| D4 | 根本原因分析 | 5Why（完整预填路径）+ 6M 排查（含判定）+ RC 总结 + 验证 | Sheet 3 / Word 第三章 |
| D5 | 永久纠正措施制定 | CA 方案评估 | Sheet 4 / Word 第四章 |
| D6 | 永久纠正措施实施 | 实施跟踪表 | Sheet 4 / Word 第四章 |
| D7 | 预防再发生 | Yokoten 横向展开 | Sheet 5 / Word 第五章 |
| D8 | 关闭与团队致谢 | 签名关闭 | Sheet 6 / Word 第六章 |
